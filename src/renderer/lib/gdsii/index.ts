...
export async function plugin(buffer: ArrayBuffer, props: Partial<AddLayerProps>, addLayer: (params: AddLayerProps) => void, addMessage: (title: string, message: string) => Promise<void>): Promise<void> {
